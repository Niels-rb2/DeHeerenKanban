  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        <div className="bento-card rounded-3xl p-8 flex flex-col items-center gap-6 shadow-lg">
          <Image
            src="/logo.svg"
            alt="Café De Heeren"
            width={400}
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold mb-1" style={{ color: 'var(--clr-text)' }}>
              Feestje Dashboard
            </h1>
            <p className="text-sm" style={{ color: 'var(--clr-text-muted)' }}>
              Gmail automatisering voor besloten feestjes
            </p>
          </div>

          <hr className="gold-divider w-full" />
          ...
          >
            <button
              type="submit"
              className="btn-accent w-full flex items-center justify-center gap-3 text-base"
            >
          ...
          <p className="text-xs text-center" style={{ color: 'var(--clr-text-subtle)' }}>
            Alleen voor medewerkers van Café De Heeren
          </p>
        </div>
      </div>
    </div>
